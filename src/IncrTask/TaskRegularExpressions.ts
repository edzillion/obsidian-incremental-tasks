export class TaskRegularExpressions {
  ...
  // added
  public static readonly progressRegex = /🔃 \w+ (\d+)\/(\d+)/;
  public static readonly descriptionRegex = /^\s*(?:- \[(.)\])? (.*?) 🔃/;
  ...
  public static readonly dependsOnRegex = new RegExp("⛔\uFE0F? *(" + this.taskIdSequenceRegex.source + ")$", "iu");
  public static readonly idRegex = new RegExp("🆔 *(" + this.taskIdRegex.source + ")$", "iu");
